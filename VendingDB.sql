...
VALUES
('Офис на Чайковского', 'А316', 30000,  12345678, 87654321, 1, 1, 1, 1, 1, 1,  @сотрудник1, @пользователь1),
('Торговый центр Олимп', 'Б322', 40000,  34567890, 09876543, 2, 2, 2, 2, 2, 2,  @сотрудник2, @пользователь2)

DECLARE @аппарат1 UNIQUEIDENTIFIER, @аппарат2 UNIQUEIDENTIFIER
DECLARE @товар1 UNIQUEIDENTIFIER, @товар2 UNIQUEIDENTIFIER

SELECT TOP 1 @аппарат1 = Код FROM Вендинговый_аппарат WHERE Серийный_номер = 12345678
SELECT TOP 1 @аппарат2 = Код FROM Вендинговый_аппарат WHERE Серийный_номер = 34567890
SELECT TOP 1 @товар1 = Код FROM Товар WHERE Название = 'Чипсы'
SELECT TOP 1 @товар2 = Код FROM Товар WHERE Название = 'Батончик'
...
VALUES
(@аппарат1, @товар1, 5, 350, '2025-12-31 15:37:12', 1),
(@аппарат2, @товар2, 5, 200, '2025-12-31 14:00:12', 2)
...
VALUES
(@аппарат1, 1, 1, '2025-10-12', 'Очистка от пыли'),
(@аппарат2, 2, 2, '2025-12-10', 'Ремонт автомата')
